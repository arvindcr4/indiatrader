...
class SimpleTraderApp(tk.Tk):
    ...
    def _create_widgets(self) -> None:
        ...
        subtitle_label = ttk.Label(title_frame, text="Professional Trading Platform", style='Zerodha.TLabel')
    ...
    def _create_signals_tab(self):
        ...
        demo_signals = [
            ...
            ("2024-01-15 10:15:00", "BANKNIFTY", "🔴 SELL", "42,300.00", "42,100.00", "42,450.00", "78%"),
    ...
    def _create_portfolio_tab(self):
        ...
        for i, (label, value) in enumerate(metrics):
            ...
            ttk.Label(metric_frame, text=value, style=color_style, font=('Segoe UI', 11, 'bold')).pack(anchor="w")
        
        # Holdings table
        holdings_columns = ("symbol", "qty", "avg_price", "ltp", "pnl", "pnl_pct")
        self.holdings_tree = ttk.Treeview(portfolio_frame, columns=holdings_columns, show="headings", 
                                         style='Zerodha.Treeview')
...
• VaR (95%): ₹8,456 per trade
    ...
    def _run_strategy(self):
        ...
        messagebox.showinfo("Strategy Complete", "Adam Mancini strategy analysis completed!\n\nResults:\n• Total Trades: 23\n• Win Rate: 68%\n• Total P&L: +₹12,456.78")
